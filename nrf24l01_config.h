...
typedef struct {
    void* gpio_user;
    nrf24l01_err_t (*gpio_init)(void*);
    nrf24l01_err_t (*gpio_deinit)(void*);
    nrf24l01_err_t (*gpio_write)(void*, uint32_t, bool);

    void* bus_user;
    nrf24l01_err_t (*bus_init)(void*);
    nrf24l01_err_t (*bus_deinit)(void*);
    nrf24l01_err_t (*bus_write)(void*, uint8_t, uint8_t const*, size_t);
    nrf24l01_err_t (*bus_read)(void*, uint8_t, uint8_t*, size_t);
