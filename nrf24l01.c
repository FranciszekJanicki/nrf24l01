...
static nrf24l01_err_t nrf24l01_gpio_init(nrf24l01_t const* nrf24l01)
{
    return nrf24l01->interface.gpio_init
               ? nrf24l01->interface.gpio_init(nrf24l01->interface.gpio_user)
               : NRF24L01_ERR_NULL;
}

static nrf24l01_err_t nrf24l01_gpio_deinit(nrf24l01_t const* nrf24l01)
{
    return nrf24l01->interface.gpio_deinit
               ? nrf24l01->interface.gpio_deinit(nrf24l01->interface.gpio_user)
               : NRF24L01_ERR_NULL;
}

static nrf24l01_err_t nrf24l01_gpio_write(nrf24l01_t const* nrf24l01, uint32_t pin, bool state)
{
    return nrf24l01->interface.gpio_write
               ? nrf24l01->interface.gpio_write(nrf24l01->interface.gpio_user, pin, state)
               : NRF24L01_ERR_NULL;
}

static nrf24l01_err_t nrf24l01_bus_init(nrf24l01_t const* nrf24l01)
{
    return nrf24l01->interface.bus_init ? nrf24l01->interface.bus_init(nrf24l01->interface.bus_user)
                                        : NRF24L01_ERR_NULL;
}

static nrf24l01_err_t nrf24l01_bus_deinit(nrf24l01_t const* nrf24l01)
{
    return nrf24l01->interface.bus_deinit
               ? nrf24l01->interface.bus_deinit(nrf24l01->interface.bus_user)
               : NRF24L01_ERR_NULL;
}

static nrf24l01_err_t nrf24l01_bus_write(nrf24l01_t const* nrf24l01,
                                         uint8_t write_address,
                                         uint8_t const* write_data,
                                         size_t write_size)
{
    return nrf24l01->interface.bus_write
               ? nrf24l01->interface.bus_write(nrf24l01->interface.bus_user,
                                               write_address,
                                               write_data,
                                               write_size)
               : NRF24L01_ERR_NULL;
...
static nrf24l01_err_t nrf24l01_bus_read(nrf24l01_t const* nrf24l01,
                                        uint8_t read_address,
                                        uint8_t* read_data,
                                        size_t read_size)
{
    return nrf24l01->interface.bus_read ? nrf24l01->interface.bus_read(nrf24l01->interface.bus_user,
                                                                       read_address,
                                                                       read_data,
                                                                       read_size)
                                        : NRF24L01_ERR_NULL;
                                   ...
                                   nrf24l01_interface_t const* interface)
{
    ...
    nrf24l01_err_t err = nrf24l01_bus_init(nrf24l01);
    err |= nrf24l01_gpio_init(nrf24l01);
...
nrf24l01_err_t nrf24l01_deinitialize(nrf24l01_t* nrf24l01)
{
    ...
    nrf24l01_err_t err = nrf24l01_bus_deinit(nrf24l01);
    err |= nrf24l01_gpio_deinit(nrf24l01);
                                          ...
                                          size_t receive_size)
{
    ...
    size_t allowed_size = {};
    nrf24l01_err_t err =
        nrf24l01_get_allowed_payload_size(nrf24l01, pipe_num, receive_size, &allowed_size);
                                           ...
                                           size_t transmit_size)
{
    ...
    size_t allowed_size = {};
    nrf24l01_err_t err =
        nrf24l01_get_allowed_payload_size(nrf24l01, pipe_num, transmit_size, &allowed_size);
                                          ...
                                          size_t* allowed_size)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_DYNPD, &data, sizeof(data));
    ...
    if (data & (1U << pipe_num)) {
        ...
        *allowed_size = proposed_size;
        ...
        err |= nrf24l01_bus_read(nrf24l01,
...
nrf24l01_err_t nrf24l01_start_listening(nrf24l01_t const* nrf24l01)
{
    ...
    if (p0_reg.rx_addr_p0) {
        ...
        err |= nrf24l01_open_reading_pipe(nrf24l01, NRF24L01_PIPE_NUM_0, &pipe_address);
    } else {
                                             ...
                                             bool* is_payload_available)
{
    ...
    *is_payload_available = (fifo_status_reg.rx_empty ? status_reg.rx_p_no == pipe_num : false);
                                          ...
                                          nrf24l01_pipe_address_t* pipe_address)
{
    ...
    nrf24l01_err_t err = nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_EN_RXADDR, data, 1UL);
    data[0] |= (1U << pipe_num);
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_EN_RXADDR, data, 1UL);
    ...
    if (pipe_num < NRF24L01_PIPE_NUM_2) {
        err |= nrf24l01_bus_write(nrf24l01,
        ...
        err |= nrf24l01_bus_write(nrf24l01,
                                  ...
                                  data,
                                  sizeof(data) - 1UL);
        err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_SETUP_AW, data + 4, 1UL);
    }

    return err;
}

nrf24l01_err_t nrf24l01_close_reading_pipe(nrf24l01_t const* nrf24l01, nrf24l01_pipe_num_t pipe_num)
{
    assert(nrf24l01);
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_EN_RXADDR, &data, sizeof(data));
    data &= ~(1U << pipe_num);
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_EN_RXADDR, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_get_config_reg(nrf24l01_t const* nrf24l01, nrf24l01_config_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_CONFIG, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_set_config_reg(nrf24l01_t const* nrf24l01, nrf24l01_config_reg_t const* reg)
{
    assert(nrf24l01 && reg);
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_CONFIG, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_get_en_aa_reg(nrf24l01_t const* nrf24l01, nrf24l01_en_aa_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_EN_AA, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_set_en_aa_reg(nrf24l01_t const* nrf24l01, nrf24l01_en_aa_reg_t const* reg)
{
    ...
    data &=
        ~((0x01U << 5U) | (0x01U << 4U) | (0x01U << 3U) | (0x01U << 2U) | (0x01U << 1U) | 0x01U);
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_EN_AA, &data, sizeof(data));

    return err;
}

nrf24l01_err_t nrf24l01_get_en_rxaddr_reg(nrf24l01_t const* nrf24l01, nrf24l01_en_rxaddr_reg_t* reg)
{
    assert(nrf24l01 && reg);
...
nrf24l01_err_t nrf24l01_get_setup_aw_reg(nrf24l01_t const* nrf24l01, nrf24l01_setup_aw_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_SETUP_AW, &data, sizeof(data));
                                         ...
                                         nrf24l01_setup_aw_reg_t const* reg)
{
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_SETUP_AW, &data, sizeof(data));
                                           ...
                                           nrf24l01_setup_retr_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_SETUP_RETR, &data, sizeof(data));
                                           ...
                                           nrf24l01_setup_retr_reg_t const* reg)
{
    ...
    return nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_SETUP_RETR, &data, sizeof(data));
}
...
nrf24l01_err_t nrf24l01_get_rf_ch_reg(nrf24l01_t const* nrf24l01, nrf24l01_rf_ch_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RF_CH, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_get_rf_setup_reg(nrf24l01_t const* nrf24l01, nrf24l01_rf_setup_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RF_SETUP, &data, sizeof(data));
                                         ...
                                         nrf24l01_rf_setup_reg_t const* reg)
{
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RF_SETUP, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_get_status_reg(nrf24l01_t const* nrf24l01, nrf24l01_status_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_STATUS, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_set_status_reg(nrf24l01_t const* nrf24l01, nrf24l01_status_reg_t const* reg)
{
    assert(nrf24l01 && reg);
    ...
    data &= ~((0x01U << 6U) | (0x01U << 5U) | (0x01U << 4U) | (0x07U << 1U) | 0x01U);
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_STATUS, &data, sizeof(data));
                                           ...
                                           nrf24l01_observe_tx_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_OBSERVE_TX, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_get_rpd_reg(nrf24l01_t const* nrf24l01, nrf24l01_rpd_reg_t* reg)
{
    ...
    nrf24l01_err_t err = nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RPD, &data, sizeof(data));
                                           ...
                                           nrf24l01_rx_addr_p0_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P0, data, sizeof(data));

    reg->rx_addr_p0 = ((((uint64_t)data[0] & 0xFFU) << 32U) | (((uint64_t)data[1] & 0xFFU) << 24U) |
                       (((uint64_t)data[2] & 0xFFU) << 16U) | (((uint64_t)data[3] & 0xFFU) << 8U) |
                       ((uint64_t)data[4] & 0xFFU));
                                           ...
                                           nrf24l01_rx_addr_p0_reg_t const* reg)
{
    ...
    return nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P0, data, sizeof(data));
}
                                           ...
                                           nrf24l01_rx_addr_p1_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P1, data, sizeof(data));

    reg->rx_addr_p1 = ((((uint64_t)data[0] & 0xFFU) << 32U) | (((uint64_t)data[1] & 0xFFU) << 24U) |
                       (((uint64_t)data[2] & 0xFFU) << 16U) | (((uint64_t)data[3] & 0xFFU) << 8U) |
                       ((uint64_t)data[4] & 0xFFU));
                                           ...
                                           nrf24l01_rx_addr_p1_reg_t const* reg)
{
    ...
    return nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P1, data, sizeof(data));
}
                                           ...
                                           nrf24l01_rx_addr_p2_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P2, &data, sizeof(data));
                                           ...
                                           nrf24l01_rx_addr_p2_reg_t const* reg)
{
    ...
    return nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P2, &data, sizeof(data));
}
                                           ...
                                           nrf24l01_rx_addr_p3_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P3, &data, sizeof(data));
                                           ...
                                           nrf24l01_rx_addr_p3_reg_t const* reg)
{
    ...
    return nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P3, &data, sizeof(data));
}
                                           ...
                                           nrf24l01_rx_addr_p4_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P4, &data, sizeof(data));
                                           ...
                                           nrf24l01_rx_addr_p4_reg_t const* reg)
{
    ...
    return nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P4, &data, sizeof(data));
}
                                           ...
                                           nrf24l01_rx_addr_5_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P5, &data, sizeof(data));
                                           ...
                                           nrf24l01_rx_addr_5_reg_t const* reg)
{
    ...
    return nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_ADDR_P5, &data, sizeof(data));
}
...
nrf24l01_err_t nrf24l01_get_tx_addr_reg(nrf24l01_t const* nrf24l01, nrf24l01_tx_addr_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_TX_ADDR, data, sizeof(data));

    reg->tx_addr = ((((uint64_t)data[0] & 0xFFU) << 32U) | (((uint64_t)data[1] & 0xFFU) << 24U) |
                    (((uint64_t)data[2] & 0xFFU) << 16U) | (((uint64_t)data[3] & 0xFFU) << 8U) |
                    ((uint64_t)data[4] & 0xFFU));
                                        ...
                                        nrf24l01_tx_addr_reg_t const* reg)
{
    ...
    return nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_TX_ADDR, data, sizeof(data));
}
...
nrf24l01_err_t nrf24l01_get_rx_pw_p0_reg(nrf24l01_t const* nrf24l01, nrf24l01_rx_pw_p0_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P0, &data, sizeof(data));
                                         ...
                                         nrf24l01_rx_pw_p0_reg_t const* reg)
{
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P0, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_get_rx_pw_p1_reg(nrf24l01_t const* nrf24l01, nrf24l01_rx_pw_p1_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P1, &data, sizeof(data));
                                         ...
                                         nrf24l01_rx_pw_p1_reg_t const* reg)
{
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P1, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_get_rx_pw_p2_reg(nrf24l01_t const* nrf24l01, nrf24l01_rx_pw_p2_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P2, &data, sizeof(data));
                                         ...
                                         nrf24l01_rx_pw_p2_reg_t const* reg)
{
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P2, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_get_rx_pw_p3_reg(nrf24l01_t const* nrf24l01, nrf24l01_rx_pw_p3_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P3, &data, sizeof(data));
                                         ...
                                         nrf24l01_rx_pw_p3_reg_t const* reg)
{
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P3, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_get_rx_pw_p4_reg(nrf24l01_t const* nrf24l01, nrf24l01_rx_pw_p4_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P4, &data, sizeof(data));
                                         ...
                                         nrf24l01_rx_pw_p4_reg_t const* reg)
{
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P4, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_get_rx_pw_p5_reg(nrf24l01_t const* nrf24l01, nrf24l01_rx_pw_p5_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P5, &data, sizeof(data));
                                         ...
                                         nrf24l01_rx_pw_p5_reg_t const* reg)
{
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_RX_PW_P5, &data, sizeof(data));
                                            ...
                                            nrf24l01_fifo_status_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_FIFO_STATUS, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_set_dynpd_reg(nrf24l01_t const* nrf24l01, nrf24l01_dynpd_reg_t const* reg)
{
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_DYNPD, &data, sizeof(data));
...
nrf24l01_err_t nrf24l01_get_feature_reg(nrf24l01_t const* nrf24l01, nrf24l01_feature_reg_t* reg)
{
    ...
    nrf24l01_err_t err =
        nrf24l01_bus_read(nrf24l01, NRF24L01_REG_ADDRESS_FEATURE, &data, sizeof(data));
                                        ...
                                        nrf24l01_feature_reg_t const* reg)
{
    ...
    err |= nrf24l01_bus_write(nrf24l01, NRF24L01_REG_ADDRESS_FEATURE, &data, sizeof(data));
